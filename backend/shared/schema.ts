...
export const leads = pgTable("leads", {
  ...
  // phone: text("phone"),
  linkedinUrl: text("linkedin_url").notNull(),
  apolloData: jsonb("apollo_data").notNull().default({}), // ✅ Make it required with default
  extractedAt: timestamp("extracted_at").defaultNow().notNull(),
});
...
// ✅ Custom schema with proper apolloData validation
export const insertLeadSchema = createInsertSchema(leads)
  ...
  .extend({
    apolloData: z.any().default({}), // ✅ Always ensure it's present
  });
